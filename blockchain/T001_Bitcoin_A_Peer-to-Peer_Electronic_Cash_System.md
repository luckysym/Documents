...
&emsp;&emsp;我们需要一种方式，让收款人明确，（对当前这些电子货币），付款人没有签署更早的交易。为了达到这个目的，重点在于最早的那笔交易，而不需要关注此后的交易是否有“重复支出”问题。确认某笔交易是否存在的方法，就是清楚每笔交易。在造币厂模型中，造币厂知悉所有的交易，并能确定哪一笔先完成。而在没有可信第三方的场景下，所有的交易必须公诸于众，并且我们需要一个系统，让所有参与者确认这些交易的历史顺序。收款人需要检验的是，在系统中大多数的节点都确认优先收到了他（即收款人）的那笔交易。
